        ...
        <section id="hero-section" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a] pt-20">
            ...
            <div className="max-w-[1400px] mx-auto px-6 lg:px-12 w-full relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="space-y-8 text-left flex flex-col justify-center">
                        ...
                        <a
                            href="/Resume.pdf"
                            download="AveryMacasa.pdf"
                            onClick={() => {
                                // Optional: Add analytics tracking here
                                console.log('Resume downloaded');
                                // You could also track this with Google Analytics, etc.
                            }}
                            className="inline-flex items-center gap-3 px-8 py-4 bg-transparent border-2 border-red-600 text-white font-semibold rounded-lg hover:bg-red-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-600/50 w-fit cursor-pointer"
                        >
                            Download CV
                        ...
                        <div className="flex items-center gap-6 pt-4">
                            ...
                            <div className="flex items-center gap-5">
                                <a href="https://www.facebook.com/averytut" className="text-neutral-400 hover:text-red-600 transition-all duration-300 hover:scale-110" aria-label="Facebook">
                                    <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                    </svg>
                                </a>
                                <a href="https://www.linkedin.com/in/avery-macasa-902950343/" className="text-neutral-400 hover:text-red-600 transition-all duration-300 hover:scale-110" aria-label="LinkedIn">
                                    <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                    </svg>
                                </a>
                                <a href="https://github.com/Eybri" className="text-neutral-400 hover:text-red-600 transition-all duration-300 hover:scale-110" aria-label="GitHub">
                                    <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="space-y-8 text-left flex flex-col justify-center">
                        <div className="space-y-4">
                            <p className="text-red-600 text-sm font-bold uppercase tracking-[0.2em]">
                                Aspiring
                            </p>
                        ...
                        <p className="text-neutral-300 text-base md:text-lg font-light">
                            <span className="text-red-600 font-bold">Tech</span> is my passion. <span className="text-red-600 font-bold">Building</span> is my drive.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3">
                ...
                <div className="w-[2px] h-16 bg-neutral-900 relative overflow-hidden rounded-full">
                    <div className="absolute top-0 left-0 w-full h-1/2 bg-red-600 animate-[bounce_2s_infinite]"></div>
                </div>
            </div>
        </section>
    );
